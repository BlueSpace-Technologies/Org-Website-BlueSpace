        ...
        <div className=" p-4">
          ...
          <div className=" mt-[2rem] lg:text-xl">
            <p className="  lg:pl-[120px] text-white font-unisans">
              ...
              brand and UX are closely connected and work
              <br />
              together. Our team specializes in creating and
              <br />
              representing digital brand identities across
              <br />
              channels, providing strategy assistance and
              <br />
          ...
          <div className="lg:pl-[120px] text-white mt-[4rem]">
            <ul>
              <li className=" border-b border-gray-200 py-3 m-3 w-2/3">
                - Brand Strategy
              </li>
              <li className=" border-b border-gray-200 py-3 m-3 w-2/3">
                - Brand Architecture
            ...
            <div className=" p-4  md:items-center">
              ...
              <div className=" mt-[2rem]  text-white lg:text-xl">
                <p className="  lg:pl-[130px] font-unisans">
                  ...
                  product at work or in their free time. We create
                  <br />
                  memorable enterprise and consumer products
                  <br />
                  as well as provide comprehensive design
                  <br />
              ...
              <div className="lg:pl-[140px] text-white mt-[4rem]">
                <ul>
                  <li className=" border-b border-gray-200 py-3 m-3">
          ...
          <div className="p-4">
            ...
            <div className=" mt-[2rem] text-white lg:text-xl">
              <p className="  lg:pl-[120px] font-unisans">
                A website is the most important channel to
                <br />
                showcase your brand to customers. Our
                <br />
                portfolio features award-winning websites
                <br />
        ...
        <div className="md:grid grid-cols-2 gap-2 ">
          ...
          <div className=" p-4 lg:mr-[90px]">
            <div className=" p-4  md:items-center">
              ...
              <div className=" mt-[2rem] text-white  lg:text-xl">
                <p className="  lg:pl-[130px] font-unisans">
                  Our designers and developers collaborate to
                  <br />
                  create websites and products that provide
                  <br />
                  exceptional user experiences and functionality.
                  <br />
                  We optimize search engine visibility, ensure
                  <br />
