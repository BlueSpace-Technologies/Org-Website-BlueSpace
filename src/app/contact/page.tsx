  ...
  return (
    <div className="bg-gray-100 py-16 ">
      <div className="container mx-auto px-4">
        <h1 className="text-6xl font-bold mb-6 text-black pl-10">
          Let{"'"}s Talk
        </h1>
        ...
        <div className="mt-10">
          <div className="lg:flex lg:justify-start pl-6">
            <div className="p-6">
              ...
              <h1 className="text-2xl underline underline-offset-8 text-black">
        ...
        <div className="container mx-auto flex mt-10 ">
          ...
          <div className="hidden md:block md:w-1/2 p-4 mt-[-28rem]">
            <Image
              className="mx-auto rounded-lg shadow-lg max-w-full h-auto text-black"
              src="/contact1.jpg"
              width={500}
              height={700}
              alt="Image"
